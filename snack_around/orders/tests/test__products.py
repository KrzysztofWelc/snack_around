...
class TestProducts(APITestCase):
    ...
    def test_add_product(self):
        self.client.credentials(HTTP_AUTHORIZATION='Token ' + self.token_restaurant.key)
    ...
    def test_get_product(self):
        ...
        res_get = self.client.get('/api/orders/product/{}/'.format(res.data['id']))
    ...
    def test_edit_product(self):
        ...
        res_edit = self.client.patch(
            '/api/orders/product/{}/'.format(res.data['id']),
            data={'price': 16.90}
        )
        ...
        res_get = self.client.get('/api/orders/product/{}/'.format(res.data['id']))
        self.assertEqual(res_get.data['price'], 16.90)
    ...
    def test_delete_product(self):
        ...
        res_delete = self.client.delete('/api/orders/product/{}/'.format(res.data['id']))
